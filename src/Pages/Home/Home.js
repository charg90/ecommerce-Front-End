...
const Home = () => {
  return (
    <>
            ...
            <Carousel>
              ...
              <Carousel.Item>
                ...
                <Carousel.Caption>
                  ...
                  <p className="icon">
                    Somos la empresa lider en latino America
                  </p>
                </Carousel.Caption>
              </Carousel.Item>
            </Carousel>
      ...
      <Container className="d-flex justify-content-center mt-5  col">
        <Row>
          <Col md={4} className="d-flex align-items-center">
            <i className="far fa-credit-card fa-4x   "></i>
            <p className="icon text-center">Aceptamos tarjetas Credito</p>
          </Col>
          <Col md={4} className="d-flex align-items-center">
            <i className="far fa-credit-card fa-4x "></i>
            <p className="icon text-center">Aceptamos tarjetas Debito</p>
          </Col>
          <Col md={4} className="d-flex align-items-center">
            <i className="fas fa-money-bill-wave-alt fa-4x  "></i>
            <p className="icon text-center ">Aceptamos Efectivo</p>
          </Col>
        </Row>
      </Container>
    </>
